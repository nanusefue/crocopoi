 ...
 */
#define USB_CFG_VENDOR_NAME     'i', 'n', 't', 'r', 'i', 'n', 'g', 'u', 'l', 'i', 's','.','o','r','g'
#define USB_CFG_VENDOR_NAME_LEN 15
/* These two values define the vendor namereturned by the USB device. The name
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'P', 'O', 'I', 'M', 'A', 'K', '3','Y'
